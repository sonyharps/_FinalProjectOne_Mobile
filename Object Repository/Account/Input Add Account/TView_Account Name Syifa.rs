...
<MobileElementEntity>
   ...
   <name>TView_Account Name Syifa</name>
   <tag></tag>
   <elementGuidId>d79a2fba-0c4b-48f4-acdd-c00d60dfb4fe</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Syifa' or . = 'Syifa') and @resource-id = 'com.example.mikebanks.bankscorpfinancial:id/txt_account_name']</locator>
