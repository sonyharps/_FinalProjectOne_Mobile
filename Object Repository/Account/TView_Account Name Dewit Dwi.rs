...
<MobileElementEntity>
   ...
   <name>TView_Account Name Dewit Dwi</name>
   <tag></tag>
   <elementGuidId>bf412229-9f76-4776-8853-75760056ac3d</elementGuidId>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Dewit Dwi' or . = 'Dewit Dwi') and @resource-id = 'com.example.mikebanks.bankscorpfinancial:id/txt_account_name']</locator>
